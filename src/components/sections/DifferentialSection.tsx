      ...
      <div className="bg-neutral-white rounded-2xl md:rounded-3xl p-5 md:p-25 shadow-sm mx-auto">
        ...
        <div className="flex flex-col md:flex-row gap-6 md:gap-16 items-center justify-center">
          ...
          <div className="flex justify-center lg:justify-start items-center">
            <div className="relative w-full md:max-w-100 overflow-hidden rounded-lg">
              <img
                src={FounderImg}
          ...
          <div className="flex flex-col gap-4 md:gap-6 md:max-w-200">
            {/* Ícone de Aspas  */}
            ...
            {/* Assinatura */}
            <div className="flex flex-col gap-1.5 pt-4 md:pt-6">
